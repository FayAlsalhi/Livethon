...
export default function Home() {
  return (
    <div className="min-h-screen bg-[#08070D] text-white relative overflow-hidden" dir="rtl" style={{ overscrollBehavior: 'none', touchAction: 'pan-y' }}>
      {/* Background Elements */}
      <div className="absolute rotate-90 -right-10 w-[350px] h-[350px] md:w-[400px] md:h-[400px] lg:w-[400px] lg:h-[700px] xl:w-[400px] xl:h-[700px] bg-[#7877C6]/25 rounded-full blur-[100px]"></div>
        ...
        <main className="pb-4 sm:pb-6 md:pb-8">
          ...
          <section id="timeline" className="mb-12 sm:mb-16 lg:mb-24 px-4">
            ...
            <div className="text-center mb-0">
              <h3 
                className="inline-block px-10 py-1 xl:px-40 xl:py-5 md:px-20 md:py-3 lg:px-30 lg:py-4 rounded-[30px] text-2xl md:text-4xl lg:text-5xl bg-gradient-to-r from-[#C0B7E8] to-[#FDCB00] text-[#343045] fade-in"
                style={{ 
                  fontSize: '52px',
                  fontWeight: 600,
          ...
          <section className="mb-12 sm:mb-16 lg:mb-24 px-2 sm:px-4 md:px-6 lg:px-8 xl:px-10">
            <div className="max-w-5xl mx-auto rounded-[32px] sm:rounded-[48px] border border-gray-400/40 shadow-[0_2px_40px_rgba(0,0,0,0.25)] box-float box-pulse" style={{
              ...
              <div className="flex items-center justify-between gap-3 sm:gap-4 px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8">
                <div className="text-right min-w-0">
                  <h3 className="text-white text-lg sm:text-2xl md:text-3xl lg:text-5xl font-bold mb-1 sm:mb-2 fade-in glow">
                    جاهز للتحدي؟
                  </h3>
                  <p className="text-white text-sm sm:text-lg md:text-2xl lg:text-4xl leading-snug fade-in glow">
                    سجل الآن وكن جزءاً من تحدي ملهم، وأصنع فرقاً معنا.
                  </p>
                </div>
                <Link 
                  href="/CRegistration"
                  className="shrink-0 inline-block px-4 sm:px-6 md:px-8 py-1.5 sm:py-2 md:py-3 rounded-3xl bg-gradient-to-r from-[#C0B7E8] to-[#FFD230] text-[#343045] font-bold text-sm sm:text-lg md:text-2xl shadow-md fade-in glow hover-effect mobile-tap"
                >
                  التسجيل
                </Link>
              </div>
          ...
          <footer className="border-t border-gray-800 py-6 sm:py-8 text-center text-gray-400 px-4">
            <p className="text-sm sm:text-base">&copy; 2025 جمعية القصيم التقنية. جميع الحقوق محفوظة.</p>
          </footer>
        </main>
      </div>
    </div>
