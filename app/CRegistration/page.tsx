      ...
      <div className="relative z-20">
        ...
        <div className="flex flex-col items-center px-3 sm:px-4 md:px-6 pb-10">
          <div className="text-center mb-6 sm:mb-8 md:mb-10 lg:mb-12">
            <p className="text-[#DFDFDF] mb-2 sm:mb-3 md:mb-4 text-md sm:text-lg md:text-3xl lg:text-4xl xl:text-5xl fade-in">
              مرحبًا بك في عالم
            </p>
            <div className="flex justify-center">
              <Image
                ...
                className="mx-auto w-40 sm:w-52 md:w-64 lg:w-80 xl:w-[26rem] object-contain select-none pointer-events-none fade-in"
              />
            </div>
          </div>
          ...
          >
            ...
            <div className="text-center space-y-3 sm:space-y-4 mb-6 sm:mb-8">
              ...
              <ol className="list-decimal list-inside text-gray-300 space-y-1 sm:space-y-2 md:space-y-3 text-md sm:text-lg md:text-2xl lg:text-2xl xl:text-3xl pr-5  md:pr-20 lg:pr-30  xl:pr-40 text-right">
                <li>المشاركة متاحة للفرق فقط، مع حد معيّن لعدد أعضاء الفريق.</li>
              ...
              <p className="text-center mt-10 text-base sm:text-lg md:text-2xl lg:text-3xl xl:text-4xl bg-[#FBEEBD] bg-clip-text text-transparent" style={{ textShadow: '0 0 10px rgba(255, 254, 249, 0.49)' }}>
                انضم إلينا مع فريق يشاركك الشغف والإبداع!
              </p>
            </div>

            <div className="flex justify-center">
              <Link href="/registration-team" className="group">
                                 <div className="rounded-[30px] p-4 sm:p-6 md:p-8 text-center transition-all duration-300 border-3 border-white/10 group-hover:border-white/30 opacity-90  hover:opacity-100 transition-opacity duration-300 hover-effect mobile-tap min-w-[200px] sm:min-w-[250px] md:min-w-[300px] lg:min-w-[400px] xl:min-w-[500px]"  style={{ background: 'linear-gradient(180deg, rgba(53,50,70,0.95) 0%, rgba(62,58,81,0.85) 100%)', boxShadow: '0 4px 60px 0 rgba(255,255,255,0.06)' }}>
